	...
	<div class="row justify-content-around">
		...
		<div class="col-10 flex-column">
			<div class="hboard pt-2 ps-3 pe-3 pb-3">
				...
				<h3 class="hanna p-5" style="text-align: center;">Dr.건강</h3>
					<div class="d-flex justify-content-around">
						<div class="input-group searchForm m-3 w-50" style="margin: auto;">
							<button class="btn btn-outline-secondary "
								type="button" data-bs-toggle="dropdown" aria-expanded="false"
								style="border: solid 1px #3478f5; border-radius: 16px 0 0 16px; background: #3478f5; color: white;">
								카테고리
							</button>
...
<!-- 							</ul> -->
							<input type="text" value="${vo.qcate }" class="form-control col-lg-5" style="border-radius: 0 16px 16px 0;" readonly="readonly">
<!-- 							<button type="submit" class="btn searchBtn" name="searBtn" -->
<!-- 								id="searBtn"> -->
<!-- 								<img alt="검색아이콘" src="/img/search.png"> -->
<!-- 							</button> -->
...
<!-- 								<label class="text-muted">아직 답변이 되지 않았습니다</label> -->
							...
							<div class="col-2 d-flex flex-column justify-content-center" style="text-align: center;">
								<button class="btn bg-primary m-3 text-white hanna" style="width: 80px; ">답변하기
								</button>
							</div>
						</div>
						<div class="card-body col-10 ">

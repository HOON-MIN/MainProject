...
<div class="mb-3">
  ...
  ${item.content}
   ...
   <div class="d-flex justify-content-end">
      <input type="button" value="목록" onclick="location.href='${mycontext}/admin/notice'" class="btn btn-primary">&nbsp;
      <input type="button" value="수정" onclick="location.href='${mycontext}/admin/notice/update?nnum=${item.nnum}'" class="btn btn-success">&nbsp;
      <input type="button" value="삭제" onclick="location.href='${mycontext}/admin/notice/delete?nnum=${item.nnum}'" class="btn btn-danger"/>&nbsp;
   </div>
</div>
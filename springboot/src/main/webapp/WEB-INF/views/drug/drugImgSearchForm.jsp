...
<div class="container">
	<div class="row">
		<div class="col-12">
			<h4 class="mt-3 mb-3 text-center" style="background-color: aqua;">약품 이미지 검색</h4>


			<input type="text" class="form-control text-center text-center mb-5" placeholder="식별표시가 잘보이도록 등록해주세요 ." readonly="readonly">
			...
			<input type="hidden" id="color" name="color" value=""> -->
					<div class="row mb-1 mt-3 ">
						<button type="button" id="imgSearchBtn" class="btn btn-info">검색</button>
					</div>

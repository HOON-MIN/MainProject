	...
	<span>
		<p>
			<a href="drugList" style="margin-right: 40px">약품리스트</a> <a href=""
				style="margin-right: 40px">이미지로약품조회</a> <a href=""
				style="margin-right: 40px">나의의약품케이스</a> <a href=""
			...
			<div class="form-holder">
				<div class="form-content">
					<div class="form-items">
						...
						<p class="text-center mb-5">모양으로 약 찾기.</p>
						<form method="get" action="shapeSearch" id="shapeSearchform">
							...
							<span style='margin-bottom: 50px'>
								<p style="font-size: 15px">
									...
									</select> 후면 색깔 선택 : <select name="drug_color_B">
										<option value="하양">하양</option>
										<option value="노랑">노랑</option>
										<option value="주황">주황</option>
										<option value="분홍">분홍</option>
							...
							<p>
								...
								</span> <span style='margin-bottom: 50px'> 전면 분할선 선택 : <select

					...
					<div class="row">
						...
						<div class="col-8 form-holder">
							<div class="form-content">
								<input class="form-control text-center  mt-5 mb-3 hanna" type="text"
									style="background-color: transparent;" value="약품 정보란"
									aria-label="readonly input example" readonly>
								<div class="form-items"
									style="text-align: center; background-color: white;">
									<p class="text-center mb-5 hanna" style="background-color: aqua;">모양으로
										약품 검색</p>
									<form method="get" action="shapeSearch" id="shapeSearchform">
										...
										<div class="input-group justify-content-center mb-5">
											<span class="input-group-text hanna" id="drug_identification">식별표시
												...
												name="drug_identification" type="text" class="form-control hanna"
